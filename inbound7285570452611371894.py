...
try:
	os.system('clear')
	print("""\33[1;96m
                    [+]Spam Sms By :บังเตอร์
                    [+]ทำโดย : เด็กติดเกม น่ะ👽
                    [+]FB : เด็กติดเกม น่ะ📞
                    [+]ห้ามเอาไปรับยิงเบอร์
                                                                                                                                                                                       """) 
	phone = input("\33[1;96m ᴘʜᴏᴇɴ : \033[0m")
	num=int(input("\33[1;96m ɴᴜᴍ : \033[0m"))
...
def API_1():  # SSO
    try:
        ...
        if str(jun) in str(req.text):
            print("\033[92m ยิงเเล้วครับ✔︎")
        else:
            print("\33[1;96m ยิงเเล้วครับ✔︎")
    except:
        pass
